...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Connection connection = DriverManager.getConnection(CONNECTION_STRING, "root", "12345");
        ...
        switch (exerciseNum) {
            case 2:
                exercise2(connection);
                break;
            case 3:
                exercise3(connection);
                break;
            // Exercise 4:
            ...
            case 4:
                exercise4(connection);
                break;
            case 5:
                exercise5(connection);
                break;
            case 6:
                exercise6(connection);
                break;
            case 7:
                exercise7(connection);
                break;
            case 8:
                exercise8(connection);
                break;
